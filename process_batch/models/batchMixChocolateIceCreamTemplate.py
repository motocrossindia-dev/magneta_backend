...
class BatchMixChocolateIceCreamTemplate(models.Model):
...
class BatchMixChocolateIceCreamTemplateIngredients(models.Model):
    type_choice = (("RMStore", "RMStore"), ("ProcessStore", "ProcessStore"))
    template = models.ForeignKey(BatchMixChocolateIceCreamTemplate, on_delete=models.CASCADE, related_name="ingredients")
