...
class BatchMixkulfyTemplate(models.Model):
...
class BatchMixkulfyTemplateIngredients(models.Model):
    type_choice = (("RMStore", "RMStore"), ("ProcessStore", "ProcessStore"))
    template = models.ForeignKey(BatchMixkulfyTemplate, on_delete=models.CASCADE, related_name="ingredients")
